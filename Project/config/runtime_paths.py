...
PROJECT_ROOT = Path(os.environ.get("PROJECT_ROOT", r"F:\Project"))
VENV_AUDIO_PYTHON = Path(
    os.environ.get("VENV_AUDIO_PYTHON", r"F:\Root\venv_audio\Scripts\python.exe")
)
AUDIO_WORKER_SCRIPT = Path(
    os.environ.get("AUDIO_WORKER_SCRIPT", str(PROJECT_ROOT / "core" / "audio_worker.py"))
)
