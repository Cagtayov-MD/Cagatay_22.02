...
def test_ollama_none_response_no_entries_verified():
    """Ollama yanıtı None olduğunda name_checker veya yüksek confidence olmadan hiçbir giriş onaylanmamalı."""
    ...
    for e in result:
        assert e.get("is_llm_verified") is False, (
            f"Akıllı fail-safe ihlali: '{e['actor_name']}' onaylandı ama onaylanmamalı"
        )
